...
def parse_args():
    ...
    parser.add_argument('-r', "--rows", action='store', default=4, help="Number of rows in passport color checker.")
    parser.add_argument('-c', "--cols", action='store', default=6, help="Number of columns in passport color checker.")
